...
haplotypes almost no node has bidirected degree 2 — jbrowse-components'
`agent-docs/reference/PANGENOME_GRAPHS.md` has the number), and **BubbleGun as
published does not reach human chr1** (the PangyPlot team measured chrY 2 s /
1 GB, chrX 30 s / 11 GB, chr9 ~40 min / 13 GB, chr1 hanging at 15+ GB).
